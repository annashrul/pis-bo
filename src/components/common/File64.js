  ...
  render() {
    return (
      <div>
        ...
        >
          {" "}
          {this.props.lang === "en" ? "Select file" : "Pilih berkas"}{" "}
        </label>
        {/*<div */}
        {/*style = {{*/}
        {/*paddingTop: '0px',*/}
        ...
        {this.state.error !== "" ? (
          <label
            id="password-error"
            style={{ fontSize: "0.7rem", color: "#dc3545", marginTop: ".1rem" }}
            htmlFor="password"
          >
            {this.state.error}
          </label>
        ...
        {this.props.showPreview ? (
          <div
            style={{
              margin: this.props.previewAlign === "center" ? "0 auto" : "",
              width: this.props.previewConfig.width,
              height: this.props.previewConfig.height,
            }}
          >
            <img
              alt="images"
              className="img-responsive"
              src={this.state.images === "" ? "" : this.state.images}
              width={this.props.previewConfig.width}
              height={this.props.previewConfig.height}
            />
          </div>
