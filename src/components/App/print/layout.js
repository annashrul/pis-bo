...
class Print3ply extends Component {
    ...
    toPdf(e){
        e.preventDefault();
        html2pdf(document.getElementById("print_3ply"), {
                    ...
                    <NoPrint>
                        <div id="non-printable">
                            <div className="text-left">
                                <button onClick={(event)=>{event.preventDefault();window.close()}} className={"btn btn-success"} style={{letterSpacing:'3px'}}> <i className={'fa fa-arrow-left'}/> KEMBALI</button>
                            </div>
