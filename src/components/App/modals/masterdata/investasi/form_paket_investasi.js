...
class FormPaketInvestasi extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <WrapperModal isOpen={this.props.isOpen && this.props.type === "formPaket"} size="lg">
        <ModalHeader toggle={this.toggle}>{this.props.detail.id === "" ? "Tambah" : "Ubah"} Paket</ModalHeader>
        <ModalBody>
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="form-group">
                <label>Tiket</label>
                <input type="text" className={"form-control"} name={"pin_required"} value={this.state.pin_required} onChange={this.handleChange} />
              </div>
              <div className="form-group">
                <label>Poin</label>
            ...
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="inputState" className="col-form-label">
                  Gambar
                  {this.props.detail.id !== "" ? <small style={{ color: "red" }}>kosongkan bila tidak akan diubah</small> : ""}
                </label>
                <br />
                <File64
                  multiple={false}
...
export default connect(mapStateToProps)(FormPaketInvestasi);
