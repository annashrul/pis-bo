...
class Index extends Component{
        ...
        if (props.data !== undefined && props.data.length !== 0) {
            if (props.data !== state.prevDataProps) {
                return {
                    ...
                    benefit1: props.data.data[0],
                    benefit2: props.data.data[1],
                    benefit3: props.data.data[2],
    ...
    handleChange(e){
        ...
        if(target === 'title'){
            ...
            if (target === 'title1' || target === 'title2' || target === 'title3'){
                const data = target === 'title1' ? this.state.benefit1 : target === 'title2' ? this.state.benefit2 : this.state.benefit3;
                const datum= Object.assign({},data,{
                    title:e.target.value
                })
                this.setState({
                    [target === 'title1'?'benefit1':target === 'title2'?'benefit2':'benefit3']: datum
                })
            }
        }
    }
    ...
    handleBtnSubmit(e,tipe){
        ...
        if(type[0]==='benefit1'){
            ...
            }else if (type[1]==='title') data={title:this.state.benefit1.title}
            id=this.state.benefit1.id;
        }else if(type[0]==='benefit2'){
            if (type[1] === 'deskripsi') {
            ...
            }else if (type[1]==='title') data={title:this.state.benefit2.title}
            id=this.state.benefit2.id;
        }else if(type[0]==='benefit3'){
            if (type[1] === 'deskripsi') {
            ...
            }else if (type[1]==='title') data={title:this.state.benefit3.title}
            id=this.state.benefit3.id;
        }else{
            ...
            <div className="card">
                <div className="card-body" style={{backgroundColor:"#343a40f0"}}>
                    <div className="row">
                        ...
                        */}
                        <div className="col-md-12">
                            <h6 className="text-light" style={{marginTop:'20px'}}>Benefit 1</h6>
                            <div className='form-group'>
                                <label>Judul <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'benefit1_title')}>Simpan</button></label>
                                <div className="input-group mb-3">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text" id="basic-addon4"><i className="fa fa-building"/></span>
                                    </div>
                                    <input type="text" name='title1' onChange={this.handleChange} value={this.state.benefit1.title} className="form-control" placeholder="" />
                                </div>
                            </div>
                            <div className='form-group'>
                                <label>Deskripsi <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'benefit1_deskripsi')}>Simpan</button></label>
                                <Editor
                                    toolbarHidden
                        ...
                        <div className="col-md-12">
                            <h6 className="text-light" style={{marginTop:'20px'}}>Benefit 2</h6>

                            <div className='form-group'>
                                <label>Judul <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'benefit2_title')}>Simpan</button></label>
                                <div className="input-group mb-3">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text" id="basic-addon4"><i className="fa fa-building"/></span>
                                    </div>
                                    <input type="text" name='title2' onChange={this.handleChange} value={this.state.benefit2.title} className="form-control" placeholder="" />
                                </div>
                            </div>
                            <div className='form-group'>
                                <label>Deskripsi <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'benefit2_deskripsi')}>Simpan</button></label>
                                <Editor
                                    toolbarHidden
                        ...
                        <div className="col-md-12">
                            <h6 className="text-light" style={{marginTop:'20px'}}>Benefit 3</h6>

                            <div className='form-group'>
                                <label>Judul <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'benefit3_title')}>Simpan</button></label>
                                <div className="input-group mb-3">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text" id="basic-addon4"><i className="fa fa-building"/></span>
                                    </div>
                                    <input type="text" name='title3' onChange={this.handleChange} value={this.state.benefit3.title} className="form-control" placeholder="" />
                                </div>
                            </div>
                            <div className='form-group'>
                                <label>Deskripsi <button className="badge badge-success" onClick={(event)=>this.handleBtnSubmit(event,'benefit3_deskripsi')}>Simpan</button></label>
                                <Editor
                                    toolbarHidden
